...
mod ffi {
    unsafe extern "C++" {
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#needsSave)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#setNeedsSave)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#authActionName)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#setAuthActionName)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#representsDefaults)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.setRepresentsDefaults)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#needsAuthorization)
        #[rust_name = "needs_authorization"]
        fn needsAuthorization(self: &KQuickConfigModule) -> bool;

        /// Returns the name of the config module.
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#name)
        fn name(self: &KQuickConfigModule) -> QString;

        /// Returns the description of the config module.
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#description)
        fn description(self: &KQuickConfigModule) -> QString;

        /// Changes the defaultness indicator visibility.
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#setDefaultsIndicatorsVisible)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#defaultsIndicatorsVisible)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#metaData)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#load)
        ...
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#save)
        fn save(self: Pin<&mut KQuickConfigModule>);

        /// Sets the configuration to default values.
        ///
        /// [C++ API documentation](https://api-staging.kde.org/kabstractconfigmodule.html#defaults)
